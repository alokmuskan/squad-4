...
export default function ResumeAnalysis({ initialTab = "upload" }: ResumeAnalysisProps) {
...
const navigate = useNavigate();
    ...
    <section style={{
      ...
      <div style={{ position:"relative", zIndex:10, maxWidth:1100, margin:"0 auto", padding:"36px 24px" }}>
        ...
        <div className="fu" style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:28 }}>
          <button onClick={() => navigate({ to: "/" })}  style={{ background:"none", border:"none", color:"rgba(255,255,255,0.5)", fontSize:14, fontWeight:600, cursor:"pointer", display:"flex", alignItems:"center", gap:6 }}>
            ← Back
          </button>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <button
              ...
              style={{ position: "absolute", top: 12, right: 16, border: "none", background: "none", fontSize: 24, cursor: "pointer" }}
            >
              ×
            </button>
            <div style={{ fontSize: 60 }}>🎉</div>
            <h2 style={{ fontSize: 24, fontWeight: 800, color: "#171C4A", marginTop: 10 }}>
              Analysis Completed!
            </h2>
            <p style={{ color: "#6B7280", marginTop: 10, lineHeight: 1.6 }}>
  ...
  navigate({ to: "/auth/login" });
              ...
              style={{
                ...
                borderRadius: 14, background: "linear-gradient(135deg,#7C3AED,#4F46E5)",
        ...
        <div style={{ position:"fixed", inset:0, background:"rgba(0,0,0,0.7)", backdropFilter:"blur(8px)", display:"flex", alignItems:"center", justifyContent:"center", zIndex:50, padding:16 }}>
          <div className="pi" style={{ background:"#fff", borderRadius:32, padding:32, maxWidth:380, width:"100%", boxShadow:"0 24px 80px rgba(0,0,0,0.4)" }}>
            ...
            <div style={{ marginTop:20, display:"flex", flexDirection:"column", gap:12 }}>
              ...
              <button onClick={() => navigate({ to: "/dashboard" })}  style={{ width:"100%", padding:"14px 0", borderRadius:18, fontSize:14, fontWeight:800, border:"none", cursor:"pointer", background:"linear-gradient(135deg,#7C3AED,#4F46E5)", color:"#fff", boxShadow:"0 6px 24px #7C3AED44" }}>
                Create Account →
              </button>
            </div>
  ...
  setShowSignup(false);
  navigate({ to: "/auth/login" });
}}  style={{ fontWeight:700, color:"#171C4A", cursor:"pointer" }}>Sign In</span>
            </p>
          </div>
        </div>
      )}
