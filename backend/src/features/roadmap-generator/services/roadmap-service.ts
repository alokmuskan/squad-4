...
// FIXED: Adjusted global path aliases to clean relative routes
import { prisma } from "../../../database";
import { AppError } from "../../../utils/errors";
import type { RoadmapPhase, RoadmapResponse } from "../types/roadmap.types";

// FIXED: Replaced explicit Prisma.InputJsonValue import mapping with standard utility return handling
...
export async function generateRoadmap(
    ...
    const totalWeeks = phases.reduce((sum: number, p: RoadmapPhase) => {
